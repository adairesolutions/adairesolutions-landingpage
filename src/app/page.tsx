          ...
          <div className="flex flex-col h-full">
            <div className="adairesolutions-navbar pt-12 pb-6 sm:pb-12 px-6">
              <div className="flex flex-col sm:flex-row justify-between">
                <span className="text-white text-2xl font-normal antialiased text-center sm:text-left">
                  <span className="font-semibold">The Adaire</span> Solutions
                </span>
                <div className="flex pt-3 sm:pt-0 justify-center sm:justify-end">
                  <a
                    href="/portfolio"
                    className="text-gray-500 hover:text-white transition-colors font-medium antialiased self-center mx-3"
                  >
                    Portfolio
                  </a>
                  <a
            ...
            <div className="p-6">
              <h1 className="text-white text-xl sm:text-3xl antialiased text-center sm:text-left font-light">
                Elevate your business with{" "}
                <span className="font-semibold">The Adaire Solutions</span>,
                offering cloud-based services that drive innovation and
            ...
            <div className="self-center sm:self-end">
              <div className="flex flex-row justify-end py-3 sm:py-0">
                <a
                  ...
                  target="_blank"
                  rel="noopener"
                  className="px-3 text-gray-500 hover:text-white transition-colors w-full sm:w-auto text-center sm:text-right self-center antialiased"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener"
                  className="pl-3 pr-3 sm:pr-0 text-gray-500 hover:text-white transition-colors w-full sm:w-auto text-center sm:text-right self-center antialiased"
                >
                  Cookie Policy
                </a>
              </div>
              <p className="text-white antialiased py-3 text-center sm:text-end">
                © 2025{" "}
              ...
              <div className="flex flex-row justify-center sm:justify-end py-3 sm:py-0">
                <a
                  href="https://github.com/adairesolutions"
                  target="_blank"
                  rel="noopener"
                ...
                >
                  <FontAwesomeIcon
                    icon={faGithub}
                    className="fa-fw px-2"
                    size="xl"
                  />
                </a>
                <a
                  href="https://linkedin.com/company/adairesolutions"
                  target="_blank"
                  rel="noopener"
                  className="text-gray-500 hover:text-white transition-colors"
                >
                ...
                <a
                  href="https://x.com/burgeonadaire"
                  target="_blank"
                  rel="noopener"
                  className="text-gray-500 hover:text-white transition-colors"
                >
